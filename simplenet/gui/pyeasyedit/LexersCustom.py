...
# }
CUSTOM_YAML_COLOR_SCHEME = {
    "Default": "#dcdcdc",  # Light gray for regular text
    "Comment": "#808080",  # Gray for comments
    "Identifier": "#f5bc42",  # Yellow for keywords
    "Keyword": "#f5bc42",  # Yellow for keywords (aligned with Identifier)
    "Number": "#FF00FF",  # Magenta for numbers
    "Reference": "#4682b4",  # Steel blue for references (unchanged)
    "DocumentDelimiter": "#ffffff",  # White for document delimiters (unchanged)
    "TextBlockMarker": "#8a2be2",  # Blue violet for block markers (unchanged)
    "SyntaxErrorMarker": "#ff0000",  # Red for syntax errors (unchanged)
    "Operator": "#FF4500",  # Orange red for operators
